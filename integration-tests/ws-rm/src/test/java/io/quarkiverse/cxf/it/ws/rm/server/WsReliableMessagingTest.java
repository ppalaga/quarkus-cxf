...
public class WsReliableMessagingTest {
    ...
    private static final String GREETME_ACTION = "https://quarkiverse.github.io/quarkiverse-docs/quarkus-cxf/test/ws-rm/WsrmHelloService/sayHello";
    ...
    public void testTwowayMessageLoss() throws Exception {
        ...
        rmFeature.setRMNamespace(RM10Constants.NAMESPACE_URI);
