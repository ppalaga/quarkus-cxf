...
* `https://quarkus.io/guides/all-config#quarkus-core_quarkus-thread-pool-core-threads#quarkus-core_quarkus-thread-pool-max-threads[quarkus.thread-pool.core-threads]`
