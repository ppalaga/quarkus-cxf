...
// The quarkus.cxf.client prefix is a workaround to be able to keep apart the generated .adoc file from the one for
// quarkus-cxf
@ConfigMapping(prefix = "quarkus.cxf.client")
...
public interface CxfWsSecurityConfig {
    ...
    interface WsSecurityClientConfig {
        ...
        /**
         * If {@code true}, an InclusiveNamespaces PrefixList will be added as a CanonicalizationMethod
         * child when generating Signatures using WSConstants.C14N_EXCL_OMIT_COMMENTS; otherwise the PrefixList will not
         * be
         * added.
         */
        @WssConfigurationConstant
