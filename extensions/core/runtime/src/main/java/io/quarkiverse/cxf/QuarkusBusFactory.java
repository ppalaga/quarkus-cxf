...
public class QuarkusBusFactory extends CXFBusFactory {
    ...
    public Bus createBus(Map<Class<?>, Object> extensions, Map<String, Object> properties) {
        ...
        final QuarkusGeneratedNamespaceClassLoader nscl = new QuarkusGeneratedNamespaceClassLoader(bus);
        bus.setExtension(nscl, NamespaceClassCreator.class);
        bus.setExtension(new ClassLoaderProxyService(nscl), ClassLoaderService.class);
        return bus;
    }
    ...
    public static class QuarkusGeneratedNamespaceClassLoader extends GeneratedNamespaceClassLoader {
        public QuarkusGeneratedNamespaceClassLoader(Bus bus) {
            super(bus);
        }
